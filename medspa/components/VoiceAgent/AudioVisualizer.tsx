...
export default function AudioVisualizer({ state = 'idle', color = '#C5A880' }) {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Determine wave intensity based on voice agent state
      let amplitude = 6;
      let frequency = 0.04;
      let speed = 0.05;
      let bars = 36;
      ...
      // Draw subtle glowing background wave
      ctx.beginPath();
      ...
      // Draw rhythmic aesthetic frequency bars
      const barWidth = width / bars;
      for (let i = 0; i < bars; i++) {
        const x = i * barWidth + barWidth / 2;
        // Bell-curve center emphasis
        ...
        gradient.addColorStop(0, 'rgba(240, 219, 188, 0.8)');
        gradient.addColorStop(0.5, color);
        gradient.addColorStop(1, 'rgba(157, 124, 82, 0.8)');
